...
const company = document.querySelector(
  "main > div > article:first-of-type > section:first-of-type div p:first-of-type"
);
const location = document.querySelector(
  "main > div > article:first-of-type > section:first-of-type div p:nth-of-type(2)"
);
const bio = document.querySelector(
  "main > div > article:first-of-type > section:first-of-type div p:nth-of-type(3)"
);
...
const uxfiles = [
  {
    ...
    image: "g-book.png",
    description:
      "Program for multiple devices to learn how to draw manga characters. An application that can make drawing a Manga character easier for novice artists.",
  },
  {
    name: "MAAS",
    link: "maas",
    image: "maas.png",
    description:
      "Studying the product (coffee maker from MAS), studying the problems of users, and providing advice to improve the product in the form of an A3 poster.",
  },
  {
    name: "YAE",
    link: "yae",
    image: "yae.png",
    description:
      "The task was to create an experience for young visitors between the ages of 7 and 12 to Artis Park in Amsterdam. Where they can roam in the park without relying on their parents to guide them.",
  },
  {
    name: "NOTED",
    link: "noted",
    image: "noted.jpg",
    description:
      "I worked on this project independently and felt nervous at first, but everything went well. It took me a lot of time to write the code properly due to learning it in another subject simultaneously.",
  },
  {
    name: "Playful-depth",
    link: "playful-depth",
...
const openCardButtons = document.querySelectorAll(
...
const previousCard = document.querySelector(
  "main>div>article:nth-of-type(3) > section > button:nth-of-type(2)"
);
const nextCard = document.querySelector(
  "main>div>article:nth-of-type(3) > section > button:first-of-type"
);
const closeCardButtons = document.querySelectorAll(
  "main>div>article:nth-of-type(3) ul li section button"
);
const detailsButtons = document.querySelectorAll(
  "main>div>article:nth-of-type(3) ul li section a"
);

const iframeArticle = document.querySelector(
  "main>div>article:nth-of-type(3) > article"
);
const iframe = document.querySelector(
  "main>div>article:nth-of-type(3) > article iframe"
);
const closeIframeButton = document.querySelector(
...
const uxWorks = document.querySelectorAll(
...
const doorButton = document.querySelector(
